...
";
        ...
        public static void GenerateFullFromFileCpp(string code, Graphics.UserControls.OldBlockType blockType) 
        {
            string constructor = "";
            string inputInit = "";
            string IOs = "";
            ...
            {
                if (blockType.Dots[i].dotType != Type.Action && blockType.Dots[i].dotType != Type.SubAction) 
                { 
                    if (blockType.Dots[i].io == IO.Input)
                    {
                        dotsInp.Add(blockType.Dots[i]);
                    }
                    else if (blockType.Dots[i].io == IO.Output) 
                    {
            ...
            {
                if (dotsInp[i].dotType == Type.Numerical)
                {
